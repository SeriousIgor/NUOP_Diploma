...
public interface ClientDao {
    ...
    String GET_CLIENT = "SELECT clientId, firstName, lastName, phoneNumber FROM Client WHERE clientId = ";

    String GET_CLIENTS = "SELECT clientId, firstName, lastName, phoneNumber FROM Client WHERE isDeleted = 0";

    String GET_CLIENTS_BY_NAME = "SELECT clientId, firstName, lastName, phoneNumber FROM Client WHERE (isDeleted = 0) AND ";
